...
public class Hase extends Tier
{
    ...
    public Hase(boolean zufaelligesAlter, Feld feld, Position position)
    {
        super(feld, position);
        if(zufaelligesAlter) {
            setAlter(rand.nextInt(MAX_ALTER));
        }
    }
    ...
    /**
     * @see GEBAER_WAHRSCHEINLICHKEIT
     */
    public double gibGebaerwahrscheinlichkeit(){
